...
export interface ChatParticipantDraft {
  ...
  cloudRun?: ChatParticipantConfig["cloudRun"];
...
export type ChatParticipantRuntimeOverride = Partial<Pick<
  ...
  "model" | "reasoningEffort" | "agentMode" | "permissions" | "remoteExecution" | "cloudRun" | "homeMachineId" | "skipToolchainPreflight" | "autoWatch"
>>;
...
export function sameParticipantDraft(draft: ChatParticipantDraft, participant: ChatParticipantConfig): boolean {
  return (
    ...
    JSON.stringify(draft.cloudRun) === JSON.stringify(participant.cloudRun) &&
...
export function updateChatParticipantDraft(
  ...
  settings: AppSettings,
  patch: Partial<Pick<ChatParticipantDraft, "roleConfigId" | "behaviorRuleIds" | "kind" | "model" | "reasoningEffort" | "avatarId" | "hostId" | "agentMode" | "permissions" | "remoteExecution" | "cloudRun" | "homeMachineId" | "skipToolchainPreflight" | "autoWatch">>
): ChatParticipantDraft {
