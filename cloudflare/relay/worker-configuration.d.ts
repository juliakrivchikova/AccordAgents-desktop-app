/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/relay/wrangler.jsonc cloudflare/relay/worker-configuration.d.ts` (hash: aa38d58018c0bda9c646fab7cdbc5032)
...
interface __BaseEnv_Env {
	...
	MAILBOXES: DurableObjectNamespace<import("./src/index").MailboxStore>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "RelayRoom" | "MailboxStore";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ACCORD_RELAY_PROVIDER" | "ACCORD_RELAY_MAX_FRAME_BYTES">> {}
}
