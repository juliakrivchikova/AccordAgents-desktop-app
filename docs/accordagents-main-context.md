...
- `package.json`
  ...
  - Repository metadata points to `https://github.com/juliakrivchikova/accordagents.git`.
  - Current package description still says "Desktop app for multi-model review, debate, and consensus." Treat that as legacy or stale for landing copy unless the product scope changes back.
