...
| desktop → machine | `machine.turn.finished.ack` | sent only after the finished turn has been stored on the desktop; the machine drops it from its outbox |
